    ...
    <div class="content">
        <div class="bg-body-tertiary rounded p-5">
            <div class="col-sm-8 mx-auto">
                <form action="{{ route('updatebuah',['id'=>$data->id]) }}" method="POST">
                    @csrf
                    @method('put')
                    <label for="">Nama buah</label>
                    <input type="text" name="nama" class="form-control" id="" value="{{ $data->nama_buah }}">
                    <br>
                    <label for="">Stok buah</label>
                    <input type="text" name="stok" class="form-control" id="" value="{{ $data->stok_buah }}">
                    <br>
                    <label for="">Harga buah</label>
                    <input type="text" name="harga" class="form-control" id="" value="{{ $data->harga_buah }}">
                    <br>
